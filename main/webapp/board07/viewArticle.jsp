...
<body>
 <form name="frmArticle" method="post" action="${contextPath }"  enctype="multipart/form-data">
  ...
  <tr>
   <td width="150" align="center" bgcolor="cyan">
      글번호
   </td>
   <td >
...
<tr>
	<td width = "20%" align ="center" bgcolor="cyan">글제목</td>
	<td>
		...
		<tr>
			<td width = "150" align ="center" bgcolor="cyan">글내용</td>
	<td>
	...
	<tr> 
	<td width="20%" align ="center" bgcolor="cyan" rowspan="2">이미지</td>
	<td>
	<input type="hidden" name ="originalFileName" value="${article.imageFileName }"/>
	<img src = "${contextPath }/download.do?
	&articleNO=${article.articleNO}&imageFileName=${article.imageFileName}" 
	id="preview"/><br>
	</td>
